...
<div class="col-xl-4 col-md-4">
    <div class="card hover-translate-y-n3 hover-shadow-lg overflow-hidden text-right">
        ...
        <div class="card-body py-4"><small class="d-block text-sm mb-2 ">ساعت‌انتشار : <?= str_replace('-','/',$model->created_at) ?></small>
            <a href="#"
               class="h5 stretched-link lh-150"><?= $model->title_fa ?></a>
            <p class="mt-3 mb-0 lh-170"><?=\yii\helpers\StringHelper::truncateWords($model->description,30)?></p></div>
