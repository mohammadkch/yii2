...
/* @var $searchModel app\models\InsuredSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Insured');
...
<div class="profile-index">
    ...
    <div class="breadcrumbs mt-3 mb-3   ">
        <ul>
            ...
            <li class="active"><a href="#!"><?=Yii::t('app','Insured')?></a></li>
        </ul>
    </div>

    <p>
        <?= Html::a(Yii::t('app', 'Create Insured'), ['create'], ['class' => 'btn btn-outline-success']) ?>
    </p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>آیا از حذف  بیمه شده طمینان کامل دارید؟</p>
